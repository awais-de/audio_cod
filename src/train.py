"""
Optimized Training Script for Neural Audio Codec
- Faster data loading with better buffering
...
class AudioDataset(Dataset):
    """Optimized audio dataset with faster loading"""
...
if __name__ == "__main__":
    ...
    if torch.cuda.is_available():
        ...
        logger.info("⚠️  Using CPU (slow training)")
